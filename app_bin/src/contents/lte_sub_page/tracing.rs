...
pub fn lte_sub_tracing_view(app:&mut RasApp, ui: &mut Ui,ctx: &egui::Context)->InnerResponse<()>{
    ui.vertical_centered(|ui|{
        ...
        //         // X축 라벨을 실제 시간으로 포맷
        //         let start = app.lte_reader_task.trac_cesq.front().unwrap().time;
        //         let ts = start + chrono::Duration::milliseconds((x.value * 1000.0) as i64);
        //         ts.format("%H:%M:%S").to_string()
        //     })
        //     .show(ui, |plot_ui| {
        //         // RSRQ 라인
        //         let points_rsrq = app.lte_reader_task.build_point(|s|s.rsrq as f64) ;
        //         plot_ui.line(
        ...
        //         // RSRP 라인
        //         let points_rsrp = app.lte_reader_task.build_point(|s|s.rsrp as f64) ;
        //         plot_ui.line(
